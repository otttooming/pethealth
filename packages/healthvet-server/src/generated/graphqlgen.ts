...
import { User, Post, Patient, History, Message } from './prisma-client';
...
export namespace PatientResolvers {
  export const defaultResolvers = {
    ...
    species: (parent: Patient) =>
      parent.species === undefined ? null : parent.species,
    breed: (parent: Patient) =>
      parent.breed === undefined ? null : parent.breed,
    sex: (parent: Patient) => (parent.sex === undefined ? null : parent.sex),
    dob: (parent: Patient) => (parent.dob === undefined ? null : parent.dob),
    weight: (parent: Patient) =>
      parent.weight === undefined ? null : parent.weight,
  };
...
export namespace MutationResolvers {
  ...
  export interface ArgsCreatePatient {
    postId: string;
    species?: string | null;
    breed?: string | null;
    sex?: string | null;
  ...
  export type CreatePatientResolver =
    | ((
        parent: undefined,
        args: ArgsCreatePatient,
        ctx: Context,
        info: GraphQLResolveInfo,
      ) => Patient | null | Promise<Patient | null>)
    | {
